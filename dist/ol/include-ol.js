 ...
 (function () {
    ...
    function load() {
        ...
        if (!inArray(includes, 'ol-debug') && !inArray(includes, 'ol@4.6.5') && !inArray(excludes, 'ol')) {
            inputCSS("../../web/libs/openlayers/6.6.1/ol.css");
            inputScript("../../web/libs/openlayers/6.6.1/ol.js");
        }
        ...
        if (inArray(includes, 'proj4')) {
            inputScript("../../web/libs/proj4/2.7.5/proj4.js");
        }
        if (inArray(includes, 'ol3-echarts')) {
            inputScript("../../web/libs/openlayers/ol3-echarts/2.0.4/ol3Echarts.min.js");
        }
